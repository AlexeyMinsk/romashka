								...
								<div class="table-responsive">
									<table class="vertical_align">
										...
										<tr>
											...
											<td>
												<a class="mt_1 i_block" href="#"> <strong>Цветы #1</strong></a>
												<div class="card_preview__linking">Оформлнение: джут</div>
											</td>
											<td>
												15 000 руб.
												<div class="card_preview__linking">5 000 руб.</div>
											</td>
											<td>
											...
											<td>
												...
												<a class="fz_22" title="Отложить" href="#"><i class="icon icon-bag"></i></a>
												<div class="btn_bask_dop">
													<a class="" title="Удалить" href="#">&times;</a>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="basket_table_info">
													<a class="mt_1 i_block" href="#"> <strong>Подарок #2</strong></a>
													<div class="card_preview__linking">Оформлнение: джут</div>
												</div>
											</td>
											<td>15 000 руб.

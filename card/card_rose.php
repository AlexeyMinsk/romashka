...
<head>
    ...
    <title>Карточка товара (розы)</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-5 bdb_min-xs mid-xs_text_center">
                            <a class="menu_collapse__btn visible-mid-xs" role="button" data-toggle="collapse" href="#collapsMenu" aria-expanded="false" aria-controls="collapsMenu">
                                Меню
                            </a>
                            ...
                            <nav class="header_menu menu_collapse collapse" id="collapsMenu">
                                <ul class="list_inline lnk_white">
                                    <li>
                                        <a class="lnk_style lnk_brd_bottom" href="#">О нас</a>
                                    </li>
                                    <li class="active">
                                        <a class="lnk_style lnk_brd_bottom" href="#">Способы оплаты</a>
                                    </li>
                                    <li>
                                        <a class="lnk_style lnk_brd_bottom" href="#">Доставка</a>
                                    </li>
                                    <li>
                                        <a class="lnk_style lnk_brd_bottom" href="#">Контакты</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                        <div class="col-xs-12 col-mid-xs-12 col-sm-4 col-md-4 header_phone text-center">
                            <a class="" href="tel:+375295555555">+375 (33) 555-55-55</a>
                            <a class="" href="tel:+375295555555">+375 (33) 555-55-55</a>
                        </div>
                            ...
                            <div class="col-xs-6 col-mid-xs-6 text_center__sm  col-sm-6 col-md-3">
                                <div class="basket">
                                    ...
                                    <div class="basket_text">
                                        <a class="basket__lnk lnk_brd" href="#">Ваша корзина <span class="">(5)</span></a>
                        ...
                        <div class="row text_center__mid-xs">
                            ...
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-0 text_center">
                                <div class="card_carousel owl-carousel">
                                    ...
                                    <div class="item"><img src="img/slider_card-2.jpg" alt="img"></div>
                                    <div class="item"><img src="img/slider_card-1.jpg" alt="img"></div>
                                    <div class="item"><img src="img/slider_card-2.jpg" alt="img"></div>
                                    <div class="item"><img src="img/slider_card-1.jpg" alt="img"></div>
                                </div>
                                <div class="dotsContentCard ">
                                    <div class="btn_secondary _rotate">
                                        <img src="img/slider_card-3-min.jpg" alt="img">
                                    </div>
                                    <div class="btn_secondary">
                                        <img src="img/slider_card-1-min.jpg" alt="img">
                                    </div>
                                    <div class="btn_secondary">
                                        <img src="img/slider_card-2-min.jpg" alt="img">
                                    </div>
                                    <div class="btn_secondary">
                                        <img src="img/slider_card-2-min.jpg" alt="img">
                                    </div>
...
<div id="popup-enter" data-effect="mfp-zoom-in" class="mfp-with-anim white-popup mfp-hide clearfix">
    ...
    <div class="col-xs-offset-1 col-xs-10 popup_wrap">
        ...
        <div class="text-center">
            <a class="fz_12" href="#">Забыли пароль?</a>
...
<div id="popup-click" data-effect="mfp-zoom-in" class="mfp-with-anim white-popup mfp-hide clearfix">
    ...
    <div class="col-xs-offset-1 col-xs-10 popup_wrap">
        <div class="text_center">
            ...
            <div class="card_preview__lnk">
                Односторонний букет
            </div>
            <div class="card_preview__price mb_2">
                400 500 руб.
            </div>
        </div>
        ...
        <form class="clearfix" action="">
            <div class="form-group col-xs-12 col-sm-6">
                ...
                <input type="text" class="form-control" id="login" placeholder="Ваше имя">
            </div>
            <div class="form-group col-xs-12 col-sm-6">
                <label for="pass">Ваш телефон</label>
                <input type="text" class="form-control" id="pass" placeholder="Ваш телефон">
            </div>
            <div class="form-group col-xs-12">
                <label for="addr">Адрес доставки</label>
                <input type="text" class="form-control" id="addr" placeholder="Ваш адрес">
            </div>
            <div class= "col-xs-offset-2 col-xs-8 text_center mt_2 mb_2">
